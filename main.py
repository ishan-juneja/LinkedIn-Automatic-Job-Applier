...
for listing in final_listings:
    ...
    #Check if the job is easy apply
    if easy_apply_button.text == "Easy Apply":
        ...
        try:
            ...
            Skip_Job = True
            submit_button = driver.find_element(By.XPATH, "/html/body/div[3]/div/div/div[2]/div/div/form/footer/div[3]/button")
        ...
        if Skip_Job == False:
            ...
            if (next_button.text == "Review"):
                ...
                print(f"Finalize Button: {finalize_button}")
